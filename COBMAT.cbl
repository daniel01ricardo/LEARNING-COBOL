      ...
      ******************************************************************
       ...
       P500-CALC.
            ...
            END-ADD
            DISPLAY "FUNCAO DE WS-NUM-2 APOS ADD: " WS-NUM-2

            DISPLAY "FUNCAO SUBTRACT: "
            SUBTRACT 2             FROM WS-NUM-2
                                   ON SIZE ERROR PERFORM P300-ERRO
            END-SUBTRACT
            DISPLAY "FUNCAO DE WS-NUM-2 APOS SUBTRACT: " WS-NUM-2

            DISPLAY "FUNCAO MULTIPLY: "
            MULTIPLY 2             BY WS-NUM-1
                                   ON SIZE ERROR PERFORM P300-ERRO
            END-MULTIPLY
            DISPLAY "FUNCAO DE WS-NUM-2 APOS MULTIPLY: " WS-NUM-2
